...
def check_images_available(inputs):
    ...
    col_names_T1 = {'L5':'LANDSAT/LT05/C01/T1_TOA', #%inputs['landsat_collection'],
                    ...
                    'L8':'LANDSAT/LC08/C01/T1_TOA', #%inputs['landsat_collection'],
    ...
    col_names_T2 = {'L5':'LANDSAT/LT05/C01/T2_TOA',# %inputs['landsat_collection'],
                    'L7':'LANDSAT/LE07/C01/T2_TOA',#%inputs['landsat_collection'],
                    'L8':'LANDSAT/LC08/C01/T2_TOA'}#%inputs['landsat_collection']}
